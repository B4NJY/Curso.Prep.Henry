...
function esDiezOCinco(numero) {
  ...
  // Tu código:
    ...
    /*SEGUNDa OPCION
    if (numero === 10 ºº numero === 5) return true;
    return false;*/
}
...
function fizzBuzz(numero) {
  ...
  /*SEGUNDA OPCION
    Siempre buscar la comprobacion mas compleja o mas larga
...
function operadoresLogicos(num1, num2, num3) {
  ...
  else if (num 1 > num2 && num3 > num2) ++num3 (Esto promero aumenta y despues retorna)*/
}
